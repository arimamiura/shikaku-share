...
export const XP_MAP: Record<string, number> = {
  ...
  "Python 3 エンジニア認定データ分析試験": 200,
  "PHP技術者認定試験（初級）": 100,
  "PHP技術者認定試験（上級）": 300,
  "HTML5プロフェッショナル認定（Lv.1）": 100,
  "HTML5プロフェッショナル認定（Lv.2）": 200,
  "Ruby Association Certified Silver": 300,
  "Ruby Association Certified Gold": 500,
  "G検定（ジェネラリスト検定）": 100,
  "E資格（エンジニア資格）": 500,
  "Kotlin Certified Developer": 300,
  "CLA（C言語プログラミング入門）": 100,
  "CPA（C++認定プログラマー）": 300,
  "OpenJS Node.js Application Developer（JSNAD）": 300,
  "App Development with Swift Certified User": 100,
  // Infra
